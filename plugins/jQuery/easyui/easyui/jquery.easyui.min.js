...
},plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","switchbutton","progressbar","tree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","paneleasy","datagrid","propertygrid","treegrid","datalist","tabs","accordion","window","dialog","form"],parse:function(_2){
var aa=[];
...
t.fitted=true;
p.fcount=_1b+1;
$(p).addClass("paneleasy-noscroll");
if(p.tagName=="BODY"){
$("html").addClass("paneleasy-fit");
}
}
...
p.fcount=_1b-1;
if(p.fcount==0){
$(p).removeClass("paneleasy-noscroll");
if(p.tagName=="BODY"){
$("html").removeClass("paneleasy-fit");
}
}
}
return false;
...
var _20f=$.data(_20d,"paneleasy");
var opts=_20f.options;
var _210=_20f.paneleasy;
var _211=_210.children(".paneleasy-header");
var _212=_210.children(".paneleasy-body");
var _213=_210.children(".paneleasy-footer");
if(_20e){
...
$(_20d).paneleasy("doLayout");
};
function _215(_216,_217){
var opts=$.data(_216,"paneleasy").options;
var _218=$.data(_216,"paneleasy").paneleasy;
if(_217){
if(_217.left!=null){
opts.left=_217.left;
}
...
function _219(_21a){
$(_21a).addClass("paneleasy-body")._size("clear");
var _21b=$("<div class=\"paneleasy\"></div>").insertBefore(_21a);
...
function _21d(_21e){
var _21f=$.data(_21e,"paneleasy");
var opts=_21f.options;
var _220=_21f.paneleasy;
_220.css(opts.style);
_220.addClass(opts.cls);
_221();
_222();
var _223=$(_21e).paneleasy("header");
var body=$(_21e).paneleasy("body");
var _224=$(_21e).siblings(".paneleasy-footer");
if(opts.border){
_223.removeClass("paneleasy-header-noborder");
body.removeClass("paneleasy-body-noborder");
_224.removeClass("paneleasy-footer-noborder");
}else{
_223.addClass("paneleasy-header-noborder");
body.addClass("paneleasy-body-noborder");
_224.addClass("paneleasy-footer-noborder");
}
_223.addClass(opts.headerCls);
body.addClass(opts.bodyCls);
$(_21e).attr("id",opts.id||"");
if(opts.content){
$(_21e).paneleasy("clear");
$(_21e).html(opts.content);
$.parser.parse($(_21e));
}
function _221(){
if(opts.noheader||(!opts.title&&!opts.header)){
_20b(_220.children(".paneleasy-header"));
_220.children(".paneleasy-body").addClass("paneleasy-body-noheader");
}else{
if(opts.header){
$(opts.header).addClass("paneleasy-header").prependTo(_220);
}else{
var _225=_220.children(".paneleasy-header");
if(!_225.length){
_225=$("<div class=\"paneleasy-header\"></div>").prependTo(_220);
}
if(!$.isArray(opts.tools)){
_225.find("div.paneleasy-tool .paneleasy-tool-a").appendTo(opts.tools);
}
_225.empty();
var _226=$("<div class=\"paneleasy-title\"></div>").html(opts.title).appendTo(_225);
if(opts.iconCls){
_226.addClass("paneleasy-with-icon");
$("<div class=\"paneleasy-icon\"></div>").addClass(opts.iconCls).appendTo(_225);
}
var tool=$("<div class=\"paneleasy-tool\"></div>").appendTo(_225);
...
$(this).addClass($(this).attr("iconCls")).addClass("paneleasy-tool-a").appendTo(tool);
});
}
}
if(opts.collapsible){
_227(tool,"paneleasy-tool-collapse",function(){
...
if(opts.minimizable){
_227(tool,"paneleasy-tool-min",function(){
_24b(_21e);
});
}
if(opts.maximizable){
_227(tool,"paneleasy-tool-max",function(){
...
if(opts.closable){
_227(tool,"paneleasy-tool-close",function(){
_239(_21e);
});
}
}
_220.children("div.paneleasy-body").removeClass("paneleasy-body-noheader");
}
};
...
function _222(){
if(opts.footer){
$(opts.footer).addClass("paneleasy-footer").appendTo(_220);
$(_21e).addClass("paneleasy-body-nobottom");
}else{
_220.children(".paneleasy-footer").remove();
$(_21e).removeClass("paneleasy-body-nobottom");
}
};
};
function _229(_22a,_22b){
var _22c=$.data(_22a,"paneleasy");
...
_22c.isLoaded=false;
$(_22a).paneleasy("clear");
if(opts.loadingMessage){
$(_22a).html($("<div class=\"paneleasy-loading\"></div>").html(opts.loadingMessage));
}
...
function _231(_232){
$(_232).paneleasy("doLayout",true);
};
function _233(_234,_235){
var opts=$.data(_234,"paneleasy").options;
var _236=$.data(_234,"paneleasy").paneleasy;
if(_235!=true){
...
var tool=_236.children(".paneleasy-header").find("a.paneleasy-tool-restore");
if(tool.length){
opts.maximized=true;
}
...
var opts=$.data(_23a,"paneleasy").options;
var _23c=$.data(_23a,"paneleasy").paneleasy;
if(_23b!=true){
...
var _240=$.data(_23e,"paneleasy");
var opts=_240.options;
var _241=_240.paneleasy;
if(_23f!=true){
if(opts.onBeforeDestroy.call(_23e)==false){
return;
}
}
$(_23e).paneleasy("clear").paneleasy("clear","footer");
_20b(_241);
opts.onDestroy.call(_23e);
};
function _238(_242,_243){
var opts=$.data(_242,"paneleasy").options;
var _244=$.data(_242,"paneleasy").paneleasy;
var body=_244.children(".paneleasy-body");
var tool=_244.children(".paneleasy-header").find("a.paneleasy-tool-collapse");
if(opts.collapsed==true){
return;
}
body.stop(true,true);
...
tool.addClass("paneleasy-tool-expand");
if(_243==true){
...
var opts=$.data(_246,"paneleasy").options;
var _248=$.data(_246,"paneleasy").paneleasy;
var body=_248.children(".paneleasy-body");
var tool=_248.children(".paneleasy-header").find("a.paneleasy-tool-collapse");
...
tool.removeClass("paneleasy-tool-expand");
if(_247==true){
...
function _237(_249){
var opts=$.data(_249,"paneleasy").options;
var _24a=$.data(_249,"paneleasy").paneleasy;
var tool=_24a.children(".paneleasy-header").find("a.paneleasy-tool-max");
if(opts.maximized==true){
return;
}
tool.addClass("paneleasy-tool-restore");
if(!$.data(_249,"paneleasy").original){
$.data(_249,"paneleasy").original={width:opts.width,height:opts.height,left:opts.left,top:opts.top,fit:opts.fit};
}
opts.left=0;
opts.top=0;
opts.fit=true;
...
function _24b(_24c){
var opts=$.data(_24c,"paneleasy").options;
var _24d=$.data(_24c,"paneleasy").paneleasy;
_24d._size("unfit");
_24d.hide();
opts.minimized=true;
opts.maximized=false;
...
function _24e(_24f){
var opts=$.data(_24f,"paneleasy").options;
var _250=$.data(_24f,"paneleasy").paneleasy;
var tool=_250.children(".paneleasy-header").find("a.paneleasy-tool-max");
if(opts.maximized==false){
return;
}
_250.show();
tool.removeClass("paneleasy-tool-restore");
$.extend(opts,$.data(_24f,"paneleasy").original);
_20c(_24f);
opts.minimized=false;
opts.maximized=false;
$.data(_24f,"paneleasy").original=null;
opts.onRestore.call(_24f);
};
function _251(_252,_253){
$.data(_252,"paneleasy").options.title=_253;
$(_252).paneleasy("header").find("div.paneleasy-title").html(_253);
};
var _254=null;
$(window).unbind(".paneleasy").bind("resize.paneleasy",function(){
if(_254){
clearTimeout(_254);
}
...
$("body").paneleasy("doLayout");
}
_254=null;
},100);
});
$.fn.paneleasy=function(_256,_257){
if(typeof _256=="string"){
return $.fn.paneleasy.methods[_256](this,_257);
}
_256=_256||{};
return this.each(function(){
var _258=$.data(this,"paneleasy");
var opts;
if(_258){
opts=$.extend(_258.options,_256);
_258.isLoaded=false;
}else{
opts=$.extend({},$.fn.paneleasy.defaults,$.fn.paneleasy.parseOptions(this),_256);
$(this).attr("title","");
_258=$.data(this,"paneleasy",{options:opts,paneleasy:_219(this),isLoaded:false});
}
_21d(this);
if(opts.doSize==true){
_258.paneleasy.css("display","block");
_20c(this);
}
...
$.fn.paneleasy.methods={options:function(jq){
return $.data(jq[0],"paneleasy").options;
},paneleasy:function(jq){
return $.data(jq[0],"paneleasy").paneleasy;
},header:function(jq){
return $.data(jq[0],"paneleasy").paneleasy.children(".paneleasy-header");
},footer:function(jq){
return jq.paneleasy("paneleasy").children(".paneleasy-footer");
},body:function(jq){
return $.data(jq[0],"paneleasy").paneleasy.children(".paneleasy-body");
...
return jq.each(function(){
_22f(type=="footer"?$(this).paneleasy("footer"):this);
});
},refresh:function(jq,href){
return jq.each(function(){
var _25d=$.data(this,"paneleasy");
_25d.isLoaded=false;
if(href){
...
return jq.each(function(){
_25f(this,"body");
_25f($(this).siblings(".paneleasy-footer")[0],"footer");
function _25f(_260,type){
if(!_260){
return;
}
var _261=_260==$("body")[0];
var s=$(_260).find("div.paneleasy:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.easyui-fluid:visible").filter(function(_262,el){
var p=$(el).parents(".paneleasy-"+type+":first");
...
$.fn.paneleasy.parseOptions=function(_266){
var t=$(_266);
var hh=t.children(".paneleasy-header,header");
var ff=t.children(".paneleasy-footer,footer");
return $.extend({},$.parser.parseOptions(_266,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href","method","header","footer",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},"openAnimation","closeAnimation",{openDuration:"number",closeDuration:"number"},]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined),header:(hh.length?hh.removeClass("paneleasy-header"):undefined),footer:(ff.length?ff.removeClass("paneleasy-footer"):undefined)});
};
$.fn.paneleasy.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,openAnimation:false,openDuration:400,closeAnimation:false,closeDuration:400,tools:null,footer:null,header:null,queryParams:{},method:"get",href:null,loadingMessage:"Loading...",loader:function(_267,_268,_269){
var opts=$(this).paneleasy("options");
if(!opts.href){
return false;
}
...
$(_270).paneleasy("move",_272.options);
if(_272.shadow){
...
var win=$(_27e).paneleasy($.extend({},_27f.options,{border:false,doSize:true,closed:true,cls:"window",headerCls:"window-header",bodyCls:"window-body "+(opts.noheader?"window-body-noheader":""),onBeforeDestroy:function(){
...
var _282=$(this).paneleasy("options");
...
_27f.window=win.paneleasy("paneleasy");
if(_27f.mask){
_27f.mask.remove();
}
if(opts.modal==true){
...
_285.window.draggable({handle:">div.paneleasy-header>div.paneleasy-title",disabled:_285.options.draggable==false,onStartDrag:function(e){
if(_285.mask){
...
return this.paneleasy(_286,_287);
}
}
_286=_286||{};
return this.each(function(){
...
return $.extend({},$.fn.paneleasy.parseOptions(_290),$.parser.parseOptions(_290,[{draggable:"boolean",resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.paneleasy.defaults,{zIndex:9000,draggable:true,resizable:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _291(_292){
...
var _2b7=0;
var _2b8="auto";
var _2b9=cc.find(">.paneleasy>.accordion-header");
if(_2b9.length){
...
var p=_2b6[i];
var h=p.paneleasy("header")._outerHeight(_2b7);
if(p.paneleasy("options").collapsible==_2bb){
var _2be=isNaN(_2bc)?undefined:(_2bc+_2b7*h.length);
p.paneleasy("resize",{width:cc.width(),height:(_2bb?_2be:undefined)});
_2bd+=p.paneleasy("paneleasy").outerHeight()-_2b7*h.length;
}
}
return _2bd;
};
...
var _2c3=$.data(_2c0,"accordion").paneleasys;
var pp=[];
for(var i=0;i<_2c3.length;i++){
var p=_2c3[i];
if(_2c1){
if(p.paneleasy("options")[_2c1]==_2c2){
pp.push(p);
}
}else{
if(p[0]==$(_2c2)[0]){
...
var _2ce=$.data(_2cc,"accordion").paneleasys;
...
pp.paneleasy($.extend({},{collapsible:true,minimizable:false,maximizable:false,closable:false,doSize:false,collapsed:true,headerCls:"accordion-header",bodyCls:"accordion-body"},_2d6,{onBeforeExpand:function(){
...
return p.paneleasy("options").collapsible;
});
for(var i=0;i<all.length;i++){
_2de(_2d5,_2c8(_2d5,all[i]));
}
}
var _2d7=$(this).paneleasy("header");
...
opts.onSelect.call(_2d5,$(this).paneleasy("options").title,_2c8(_2d5,this));
},onBeforeCollapse:function(){
...
var _2d8=$(this).paneleasy("header");
...
opts.onUnselect.call(_2d5,$(this).paneleasy("options").title,_2c8(_2d5,this));
}}));
var _2d9=pp.paneleasy("header");
var tool=_2d9.children("div.paneleasy-tool");
tool.children("a.paneleasy-tool-collapse").hide();
var t=$("<a href=\"javascript:void(0)\"></a>").addClass("accordion-collapse accordion-expand").appendTo(tool);
t.bind("click",function(){
_2da(pp);
return false;
});
pp.paneleasy("options").collapsible?t.show():t.hide();
_2d9.click(function(){
_2da(pp);
return false;
});
function _2da(p){
var _2db=p.paneleasy("options");
if(_2db.collapsible){
...
p.paneleasy("expand",opts.animate);
};
...
p.paneleasy("collapse",opts.animate);
};
function _2e4(_2e5){
...
function _2e1(_2e9){
var _2ea=$.data(_2e9,"accordion").paneleasys;
...
var _2f3=_2f2.paneleasys;
_2e1(_2f0);
var _2f4=_2cb(_2f0,_2f1);
var _2f5=_2f4.paneleasy("options").title;
...
$.data(this,"accordion",{options:$.extend({},$.fn.accordion.defaults,$.fn.accordion.parseOptions(this),_2f7),accordion:$(this).addClass("accordion"),paneleasys:[]});
init(this);
}
_2cf(this);
_2b2(this);
...
},paneleasys:function(jq){
return $.data(jq[0],"accordion").paneleasys;
...
return _2c6(jq[0]);
},getpaneleasy:function(jq,_2fb){
return _2cb(jq[0],_2fb);
},getpaneleasyIndex:function(jq,_2fc){
...
var _31e=cc.children("div.tabs-paneleasys");
...
cc.children("div.tabs-paneleasys").children("div").each(function(i){
var opts=$.extend({},$.parser.parseOptions(this),{selected:($(this).attr("selected")?true:undefined)});
_33a(_32c,opts,$(this));
});
...
if(li.length){
var _333=_332(li);
var _334=_331.tabs[_333].paneleasy("options");
if(_334.collapsible){
...
var _339=$(_337).children("div.tabs-paneleasys");
_338.removeClass("tabs-header-top tabs-header-bottom tabs-header-left tabs-header-right");
_339.removeClass("tabs-paneleasys-top tabs-paneleasys-bottom tabs-paneleasys-left tabs-paneleasys-right");
...
_339.addClass("tabs-paneleasys-top");
}else{
if(opts.tabPosition=="left"){
_338.addClass("tabs-header-left");
_339.addClass("tabs-paneleasys-right");
}else{
if(opts.tabPosition=="right"){
_338.addClass("tabs-header-right");
_339.addClass("tabs-paneleasys-left");
}
}
}
}
...
_339.removeClass("tabs-paneleasys-noborder");
}else{
_338.addClass("tabs-header-noborder");
_339.addClass("tabs-paneleasys-noborder");
}
opts.doSize=true;
};
...
var _33e=$(_33b).children("div.tabs-paneleasys");
...
pp.insertBefore(_33e.children("div.paneleasy:eq("+_33c.index+")"));
tabs.splice(_33c.index,0,pp);
}
pp.paneleasy($.extend({},_33c,{tab:tab,border:false,noheader:true,closed:true,doSize:false,iconCls:(_33c.icon?_33c.icon:undefined),onLoad:function(){
if(_33c.onLoad){
...
var _33f=$(this).paneleasy("options");
...
var _342=$(this).paneleasy("paneleasy");
...
var _343=$(this).paneleasy("options");
...
$(this).paneleasy("options").tab.removeClass("tabs-selected");
},onClose:function(){
if(_33c.onClose){
_33c.onClose.call(this);
}
var _344=$(this).paneleasy("options");
_33d.options.onUnselect.call(_33b,_344.title,_345(_33b,this));
}}));
$(_33b).tabs("update",{tab:pp,options:pp.paneleasy("options"),type:"header"});
};
...
var tab=tabs[i];
if(tab.paneleasy("options").title==_35d){
if(_35e){
tabs.splice(i,1);
}
return tab;
...
for(var i=0;i<tabs.length;i++){
var tab=tabs[i];
if(tab.paneleasy("options").tab.hasClass("tabs-selected")){
return tab;
}
}
return null;
...
var tabs=_363.tabs;
for(var i=0;i<tabs.length;i++){
if(tabs[i].paneleasy("options").selected){
_34a(_362,i);
return;
}
}
...
function _366(_36a){
$(_36a).children("div.tabs-paneleasys").each(function(){
$(this).stop(true,true);
});
};
...
return jq.each(function(){
$(this).tabs("getTab",_37e).paneleasy("options").tab.removeClass("tabs-disabled");
});
},disableTab:function(jq,_37f){
return jq.each(function(){
$(this).tabs("getTab",_37f).paneleasy("options").tab.addClass("tabs-disabled");
});
...
_397.center.paneleasy("resize",cpos);
function _398(pp,type){
if(!pp.length||!_399(pp)){
return;
}
var opts=pp.paneleasy("options");
pp.paneleasy("resize",{width:cc.width(),height:opts.height});
var _39b=pp.paneleasy("paneleasy").outerHeight();
pp.paneleasy("move",{left:0,top:(type=="n"?0:cc.height()-_39b)});
cpos.height-=_39b;
if(type=="n"){
cpos.top+=_39b;
...
var opts=pp.paneleasy("options");
pp.paneleasy("resize",{width:opts.width,height:cpos.height});
var _39c=pp.paneleasy("paneleasy").outerWidth();
pp.paneleasy("move",{left:(type=="e"?cc.width()-_39c:0),top:cpos.top});
cpos.width-=_39c;
if(type=="w"){
cpos.left+=_39c;
if(!opts.split&&opts.border){
...
function _39e(cc){
cc.children("div").each(function(){
var opts=$.fn.layout.parsepaneleasyOptions(this);
...
var _3a3=$.data(_3a1,"layout").paneleasys;
var cc=$(_3a1);
var dir=_3a2.region;
if(_3a3[dir].length){
return;
...
var _3a4=$.extend({},$.fn.layout.paneleasydefaults,{width:(pp.length?parseInt(pp[0].style.width)||pp.outerWidth():"auto"),height:(pp.length?parseInt(pp[0].style.height)||pp.outerHeight():"auto"),doSize:false,collapsible:true,onOpen:function(){
var tool=$(this).paneleasy("header").children("div.paneleasy-tool");
tool.children("a.paneleasy-tool-collapse").hide();
...
$(this).paneleasy("options").collapsible?t.show():t.hide();
}},_3a2,{cls:((_3a2.cls||"")+" layout-paneleasy layout-paneleasy-"+dir),bodyCls:((_3a2.bodyCls||"")+" layout-body")});
pp.paneleasy(_3a4);
_3a3[dir]=pp;
var _3a7={north:"s",south:"n",east:"w",west:"e"};
var _3a8=pp.paneleasy("paneleasy");
if(pp.paneleasy("options").split){
_3a8.addClass("layout-split-"+dir);
}
_3a8.resizable($.extend({},{handles:(_3a7[dir]||""),disabled:(!pp.paneleasy("options").split),onStartResize:function(e){
_392=true;
...
var _3b0=$.data(_3ae,"layout").paneleasys;
if(_3b0[_3af].length){
_3b0[_3af].paneleasy("destroy");
_3b0[_3af]=$();
var _3b1="expand"+_3af.substring(0,1).toUpperCase()+_3af.substring(1);
if(_3b0[_3b1]){
_3b0[_3b1].paneleasy("destroy");
_3b0[_3b1]=undefined;
}
}
};
...
var _3b6=$.data(_3b3,"layout").paneleasys;
var p=_3b6[_3b4];
var _3b7=p.paneleasy("options");
...
if(!_3b6[_3b8]){
_3b6[_3b8]=_3b9(_3b4);
_3b6[_3b8].paneleasy("paneleasy").bind("click",function(){
p.paneleasy("expand",false).paneleasy("open");
var _3ba=_3bb();
p.paneleasy("resize",_3ba.collapse);
p.paneleasy("paneleasy").animate(_3ba.expand,function(){
$(this).unbind(".layout").bind("mouseleave.layout",{region:_3b4},function(e){
if(_392==true){
return;
}
if($("body>div.combo-p>div.combo-paneleasy:visible").length){
return;
}
...
var _3bc=_3bb();
if(!_399(_3b6[_3b8])){
_3b6.center.paneleasy("resize",_3bc.resizeC);
}
p.paneleasy("paneleasy").animate(_3bc.collapse,_3b5,function(){
p.paneleasy("collapse",false).paneleasy("close");
_3b6[_3b8].paneleasy("open").paneleasy("resize",_3bc.expandP);
$(this).unbind(".layout");
});
function _3b9(dir){
var icon;
...
p.paneleasy($.extend({},$.fn.layout.paneleasydefaults,{cls:("layout-expand layout-expand-"+dir),title:"&nbsp;",closed:true,minWidth:0,minHeight:0,doSize:false,tools:[{iconCls:icon,handler:function(){
_3c2(_3b3,_3b4);
return false;
}}]}));
p.paneleasy("paneleasy").hover(function(){
...
function _3bb(){
var cc=$(_3b3);
var _3bd=_3b6.center.paneleasy("options");
var _3be=_3b7.collapsedSize;
if(_3b4=="east"){
var _3bf=p.paneleasy("paneleasy")._outerWidth();
...
if(_3b4=="north"){
var _3c1=p.paneleasy("paneleasy")._outerHeight();
var hh=_3bd.height;
if(!_399(_3b6.expandNorth)){
hh+=_3c1-_3be+((_3b7.split||!_3b7.border)?1:0);
}
_3b6.east.add(_3b6.west).add(_3b6.expandEast).add(_3b6.expandWest).paneleasy("resize",{top:_3be-1,height:hh});
...
_3b6.east.add(_3b6.west).add(_3b6.expandEast).add(_3b6.expandWest).paneleasy("resize",{height:hh});
...
var _3c5=$.data(_3c3,"layout").paneleasys;
var p=_3c5[_3c4];
var _3c6=p.paneleasy("options");
if(_3c6.onBeforeExpand.call(p)==false){
return;
}
var _3c7="expand"+_3c4.substring(0,1).toUpperCase()+_3c4.substring(1);
if(_3c5[_3c7]){
_3c5[_3c7].paneleasy("close");
p.paneleasy("paneleasy").stop(true,true);
p.paneleasy("expand",false).paneleasy("open");
var _3c8=_3c9();
p.paneleasy("resize",_3c8.collapse);
p.paneleasy("paneleasy").animate(_3c8.expand,function(){
_393(_3c3);
});
}
function _3c9(){
var cc=$(_3c3);
var _3ca=_3c5.center.paneleasy("options");
if(_3c4=="east"&&_3c5.expandEast){
return {collapse:{left:cc.width(),top:_3ca.top,height:_3ca.height},expand:{left:cc.width()-p.paneleasy("paneleasy")._outerWidth()}};
}else{
if(_3c4=="west"&&_3c5.expandWest){
return {collapse:{left:-p.paneleasy("paneleasy")._outerWidth(),top:_3ca.top,height:_3ca.height},expand:{left:0}};
}else{
if(_3c4=="north"&&_3c5.expandNorth){
return {collapse:{top:-p.paneleasy("paneleasy")._outerHeight(),width:cc.width()},expand:{top:0}};
}else{
if(_3c4=="south"&&_3c5.expandSouth){
return {collapse:{top:cc.height(),width:cc.width()},expand:{top:cc.height()-p.paneleasy("paneleasy")._outerHeight()}};
}
}
}
}
...
if(pp.length){
return pp.paneleasy("paneleasy").is(":visible");
}else{
return false;
}
};
function _3cb(_3cc){
var _3cd=$.data(_3cc,"layout").paneleasys;
_3ce("east");
_3ce("west");
_3ce("north");
_3ce("south");
function _3ce(_3cf){
var p=_3cd[_3cf];
if(p.length&&p.paneleasy("options").collapsed){
_3b2(_3cc,_3cf,0);
}
};
};
function _3d0(_3d1,_3d2,_3d3){
var p=$(_3d1).layout("paneleasy",_3d2);
p.paneleasy("options").split=_3d3;
var cls="layout-split-"+_3d2;
var _3d4=p.paneleasy("paneleasy").removeClass(cls);
if(_3d3){
_3d4.addClass(cls);
}
...
$.data(this,"layout",{options:opts,paneleasys:{center:$(),north:$(),south:$(),east:$(),west:$()}});
init(this);
}
_393(this);
_3cb(this);
...
},paneleasy:function(jq,_3d9){
return $.data(jq[0],"layout").paneleasys[_3d9];
...
_3a0(this,_3dc);
_393(this);
if($(this).layout("paneleasy",_3dc.region).paneleasy("options").collapsed){
...
$.fn.layout.parsepaneleasyOptions=function(_3e1){
var t=$(_3e1);
return $.extend({},$.fn.paneleasy.parseOptions(_3e1),$.parser.parseOptions(_3e1,["region",{split:"boolean",collpasedSize:"number",minWidth:"number",minHeight:"number",maxWidth:"number",maxHeight:"number"}]));
};
$.fn.layout.paneleasydefaults=$.extend({},$.fn.paneleasy.defaults,{region:null,split:false,collapsedSize:28,minWidth:10,minHeight:10,maxWidth:10000,maxHeight:10000});
})(jQuery);
(function($){
$(function(){
...
var _5d1=_5d0.paneleasy;
if(_5cf){
$.extend(opts,_5cf);
}
if(opts.fit==true){
var p=_5d1.paneleasy("paneleasy").parent();
opts.width=p.width();
opts.height=p.height();
}
_5d1.paneleasy("resize",opts);
};
function _5d2(_5d3){
var _5d4=$.data(_5d3,"datagrid");
var opts=_5d4.options;
var dc=_5d4.dc;
var wrap=_5d4.paneleasy;
var _5d5=wrap.width();
...
_5fd.paneleasy({doSize:false,cls:"datagrid"});
...
return {paneleasy:_5fd,frozenColumns:cc[0],columns:cc[1],dc:{view:view,view1:_5fe,view2:_5ff,header1:_5fe.children("div.datagrid-header").children("div.datagrid-header-inner"),header2:_5ff.children("div.datagrid-header").children("div.datagrid-header-inner"),body1:_5fe.children("div.datagrid-body").children("div.datagrid-body-inner"),body2:_5ff.children("div.datagrid-body"),footer1:_5fe.children("div.datagrid-footer").children("div.datagrid-footer-inner"),footer2:_5ff.children("div.datagrid-footer").children("div.datagrid-footer-inner")}};
};
function _600(_601){
var _602=$.data(_601,"datagrid");
var opts=_602.options;
var dc=_602.dc;
var _603=_602.paneleasy;
_602.ss=$(_601).datagrid("createStyleSheet");
_603.paneleasy($.extend({},opts,{id:null,doSize:false,onResize:function(_604,_605){
...
$.data(this,"datagrid",{options:opts,paneleasy:_722.paneleasy,dc:_722.dc,ss:null,selectedRows:[],checkedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_600(this);
_615(this);
_5cd(this);
...
var _74b=$.data(jq[0],"datagrid").paneleasy.paneleasy("options");
...
return _5be(jq[0]);
},getpaneleasy:function(jq){
return $.data(jq[0],"datagrid").paneleasy;
},getPager:function(jq){
return $.data(jq[0],"datagrid").paneleasy.children("div.datagrid-pager");
...
if(opts.loadMsg){
var _753=$(this).datagrid("getpaneleasy");
...
var _754=$(this).datagrid("getpaneleasy");
...
return jq.each(function(){
var _773=$(this).datagrid("getpaneleasy");
...
return jq.each(function(){
var _775=$(this).datagrid("getpaneleasy");
...
var t=$(_777);
return $.extend({},$.fn.paneleasy.parseOptions(_777),$.parser.parseOptions(_777,["url","toolbar","idField","sortName","sortOrder","pagePosition","resizeHandle",{sharedStyleSheet:"boolean",fitColumns:"boolean",autoRowHeight:"boolean",striped:"boolean",nowrap:"boolean"},{rownumbers:"boolean",singleSelect:"boolean",ctrlSelect:"boolean",checkOnSelect:"boolean",selectOnCheck:"boolean"},{pagination:"boolean",pageSize:"number",pageNumber:"number"},{multiSort:"boolean",remoteSort:"boolean",showHeader:"boolean",showFooter:"boolean"},{scrollbarSize:"number"}]),{pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined),loadMsg:(t.attr("loadMsg")!=undefined?t.attr("loadMsg"):undefined),rowStyler:(t.attr("rowStyler")?eval(t.attr("rowStyler")):undefined)});
};
...
if(opts.showFooter){
var _7bf=$(_7bd).datagrid("getpaneleasy").find("div.datagrid-footer");
...
var p=$(e.target).closest("div.datagrid-view,div.combo-paneleasy");
if(p.length){
return;
}
_7fe(_7fd);
...
var body=$(_87c).datagrid("getpaneleasy").find("div.datagrid-body");
if(_87e){
...
var body=$(_88b).datagrid("getpaneleasy").find("div.datagrid-view2 div.datagrid-body");
var _88d=[];
if(_88c){
_88e(_88c);
}else{
...
var view=$(_894).datagrid("getpaneleasy").children("div.datagrid-view");
...
if(opts.lines){
t.treegrid("getpaneleasy").addClass("tree-lines");
}else{
t.treegrid("getpaneleasy").removeClass("tree-lines");
return;
}
t.treegrid("getpaneleasy").find("span.tree-indent").removeClass("tree-line tree-join tree-joinbottom");
t.treegrid("getpaneleasy").find("div.datagrid-cell").removeClass("tree-node-last tree-root-first tree-root-one");
...
$("body>div.combo-p>div.combo-paneleasy:visible").paneleasy("close");
});
});
function _942(_943){
...
if(!_944.paneleasy){
_944.paneleasy=$("<div class=\"combo-paneleasy\"></div>").appendTo("body");
_944.paneleasy.paneleasy({minWidth:opts.paneleasyMinWidth,maxWidth:opts.paneleasyMaxWidth,minHeight:opts.paneleasyMinHeight,maxHeight:opts.paneleasyMaxHeight,doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
var _945=$(this).paneleasy("options").comboTarget;
var _946=$.data(_945,"combo");
if(_946){
_946.options.onShowpaneleasy.call(_945);
}
},onBeforeClose:function(){
_941(this);
},onClose:function(){
var _947=$(this).paneleasy("options").comboTarget;
var _948=$(_947).data("combo");
if(_948){
_948.options.onHidepaneleasy.call(_947);
}
}});
}
...
function _94d(_94e){
var _94f=$.data(_94e,"combo").paneleasy;
if(_94f.is(":visible")){
_950(_94e);
}else{
var p=$(_94e).closest("div.combo-paneleasy");
$("div.combo-paneleasy:visible").not(_94f).not(p).paneleasy("close");
$(_94e).combo("showpaneleasy");
}
$(_94e).combo("textbox").focus();
};
function _941(_951){
$(_951).find(".combo-f").each(function(){
var p=$(this).combo("paneleasy");
if(p.is(":visible")){
p.paneleasy("close");
}
});
...
var _955=_954.paneleasy;
if(!opts.editable){
_94d(_953);
}else{
var p=$(_953).closest("div.combo-paneleasy");
$("div.combo-paneleasy:visible").not(_955).not(p).paneleasy("close");
}
};
function _956(e){
...
var _95c=_95b.combo;
var _95d=_95b.paneleasy;
var opts=$(_95a).combo("options");
var _95e=_95d.paneleasy("options");
_95e.comboTarget=_95a;
if(_95e.closed){
_95d.paneleasy("paneleasy").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:$.fn.window.defaults.zIndex++),left:-999999});
_95d.paneleasy("resize",{width:(opts.paneleasyWidth?opts.paneleasyWidth:_95c._outerWidth()),height:opts.paneleasyHeight});
_95d.paneleasy("paneleasy").hide();
_95d.paneleasy("open");
}
(function(){
if(_95d.is(":visible")){
_95d.paneleasy("move",{left:_95f(),top:_960()});
setTimeout(arguments.callee,200);
}
})();
function _95f(){
var left=_95c.offset().left;
if(opts.paneleasyAlign=="right"){
...
function _950(_961){
var _962=$.data(_961,"combo").paneleasy;
_962.paneleasy("close");
};
...
$.data(this,"combo",{options:$.extend(true,{cloned:true},$(from).combo("options")),combo:$(this).next(),paneleasy:$(from).combo("paneleasy")});
$(this).addClass("combo-f").attr("comboName",$(this).attr("textboxName"));
});
},paneleasy:function(jq){
return $.data(jq[0],"combo").paneleasy;
},destroy:function(jq){
return jq.each(function(){
_94a(this);
});
},showpaneleasy:function(jq){
return jq.each(function(){
_959(this);
});
},hidepaneleasy:function(jq){
return jq.each(function(){
_950(this);
});
},clear:function(jq){
...
var t=$(_982);
return $.extend({},$.fn.textbox.parseOptions(_982),$.parser.parseOptions(_982,["separator","paneleasyAlign",{paneleasyWidth:"number",hasDownArrow:"boolean",delay:"number",selectOnNavigation:"boolean"},{paneleasyMinWidth:"number",paneleasyMaxWidth:"number",paneleasyMinHeight:"number",paneleasyMaxHeight:"number"}]),{paneleasyHeight:(t.attr("paneleasyHeight")=="auto"?"auto":parseInt(t.attr("paneleasyHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined)});
};
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_952,keydown:_956,paste:_956,drop:_956},paneleasyWidth:null,paneleasyHeight:200,paneleasyMinWidth:null,paneleasyMaxWidth:null,paneleasyMinHeight:null,paneleasyMaxHeight:null,paneleasyAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
},query:function(q,e){
}},onShowpaneleasy:function(){
},onHidepaneleasy:function(){
...
var _98f=$(_98e).combobox("paneleasy");
...
$(_9a1).combo("paneleasy").html(dd.join(""));
if(opts.multiple){
_996(_9a1,_9a4,_9a2);
}else{
...
$(_9b6).combo($.extend({},opts,{onShowpaneleasy:function(){
$(_9b6).combo("paneleasy").find("div.combobox-item:hidden,div.combobox-group:hidden").show();
_98a(_9b6,$(_9b6).combobox("getValue"));
opts.onShowpaneleasy.call(_9b6);
}}));
$(_9b6).combo("paneleasy").unbind().bind("mouseover",function(e){
...
var grid=_9f4.grid;
$(_9f3).addClass("combogrid-f").combo($.extend({},opts,{onShowpaneleasy:function(){
var p=$(this).combogrid("paneleasy");
var _9f5=p.outerHeight()-p.height();
var _9f6=p._size("minHeight");
var _9f7=p._size("maxHeight");
var dg=$(this).combogrid("grid");
dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.paneleasyHeight))?"auto":"100%"),minHeight:(_9f6?_9f6-_9f5:""),maxHeight:(_9f7?_9f7-_9f5:"")});
var row=dg.datagrid("getSelected");
if(row){
dg.datagrid("scrollTo",dg.datagrid("getRowIndex",row));
}
opts.onShowpaneleasy.call(this);
}}));
var _9f8=$(_9f3).combo("paneleasy");
if(!grid){
...
$(_a27).addClass("datebox-f").combo($.extend({},opts,{onShowpaneleasy:function(){
_a29(this);
_a2a(this);
_a2b(this);
...
if(!_a28.calendar){
var _a2c=$(_a27).combo("paneleasy").css("overflow","hidden");
_a2c.paneleasy("options").onBeforeDestroy=function(){
...
$.fn.datebox.defaults=$.extend({},$.fn.combo.defaults,{paneleasyWidth:180,paneleasyHeight:"auto",sharedCalendar:null,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
$(this).closest("div.combo-paneleasy").paneleasy("close");
}}],formatter:function(date){
...
$(_a51).datebox($.extend({},opts,{onShowpaneleasy:function(){
...
if(!_a52.spinner){
var _a54=$(_a51).datebox("paneleasy");
...
$(_a6c).datetimebox("hidepaneleasy");
}},{text:function(_a6d){
...
$(_a70).datetimebox("hidepaneleasy");
}}],formatter:function(date){
var h=date.getHours();
