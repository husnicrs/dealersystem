       ...
       <table id="datagrid"  class="table table-bordered table-hover">
		...
		<div class="modal fade" id="myModals" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog" style="width:50% !important">
                 ...
                 <input type="hidden" id="inventorybrandid" name="inventorybrandid">
                 <input type="hidden" id="inventorytypeid" name="inventorytypeid">
                 <input type="hidden" id="inventorysizeid" name="inventorysizeid">
                 <input type="hidden" id="barcode" name="barcode">
                        ...
                        <div class="modal-body">
							...
							<input type="hidden" class="form-control" id="type" name="type">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="inventorycode" name="inventorycode">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="real_name" class="col-sm-3 control-label">Nama Sparepart</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="inventoryname" name="inventoryname" data-date-format="yyyy-mm-dd">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="real_name" class="col-sm-3 control-label">Satuan</label>
                                    <div class="col-sm-9">
                                    <select class="form-control"  style="width: 100%;" name="unitname" id="unitname"  placeholder="Unit">
                                       <?php
                                            $rl = new Combobox();
                                            $datarl = $rl->showUnit();
                                ...
                                <div class="form-group">
                                    <label for="real_name" class="col-sm-3 control-label">Harga (HET)</label>
                                    <div class="col-sm-9">
					...
					<div class="modal-footer">
                        ...
                        <button type="submit" id="submitaddnew" onClick="submitDataAdd()" class="btn btn-primary btn-flat pull-right">Simpan dan Tambah</button>
