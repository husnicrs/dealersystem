...
var modulename = "vehiclegroup";
var moduledesc = "Golongan Kendaraan";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#vehiclegroupname").val(data.vehiclegroupname);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#vehiclegroupname").val(data.vehiclegroupname);
			$("#type").val("delete");
			$("#vehiclegroupname").val(data.vehiclegroupname).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("vehiclegroupname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#vehiclegroupname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
