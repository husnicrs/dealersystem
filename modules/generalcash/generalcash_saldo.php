        ...
        <form class="form-horizontal" id="formData" name="formData"  method="post" action="" enctype="multipart/form-data">
          <div class="box-body">
                <table id="dg" style="height:600px"
                    ...
                    <thead>
                        <tr>
                            <th field="datetrans" width="100" align="left">Tanggal</th>
                            <th field="notrans" width="100" align="left">Nomor</th>
                            <th field="acccode" width="100" align="left">Kode Akun</th>
                            <th field="accname" width="100" align="left">Nama Akun</th>
                            <th field="description" width="100" align="left">Keterangan</th>
