...
$slip = new Slip();
	...
	if(isset($_REQUEST['saveclose'])){
        extract($_REQUEST);
		$key = $_GET['key'];
        ${"$modulename"}->saveclose($key, $datetrans, $customerid, $paytypeid, $remark);
	}
    ...
    <div class="col-xs-12">
       ...
       <input type="hidden" class="form-control" id="type" name="type" value="generate">
            <div class="box-header with-border">
               ...
               <div class="col-md-4">
                    <div class="form-group">
                        <label for="real_name" class="col-sm-3 control-label">No Retur</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="transno" name="transno"  disabled="disabled" value="<?php echo $notrans; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="real_name" class="col-sm-3 control-label">Tgl Retur</label>
                        <div class="col-sm-9">
                ...
                <div class="col-md-4" style="margin-bottom:-20px !important">
                    <div class="form-group">
                        <label for="real_name" class="col-sm-3 control-label">Pelanggan</label>
                        <div class="col-sm-9">
                            <select class="form-control select2"  style="width: 100%;" name="customerid" id="customerid"  placeholder="Customer">
                    ...
                    <div class="form-group">
                        <label for="real_name" class="col-sm-3 control-label">Jenis Pembayaran</label>
                        <div class="col-sm-9">
                ...
                <table id="dg" style="height:350px"
                    ...
                    <thead>
                        <tr>
                                    ...
                                    editor:{
                                        ...
                                        options:{
                                            ...
                                            columns:[[
                                                ...
                                                {field:'unitprice',title:'Price',width:70}
                                            ]],
                            ...
                            <th field="unitprice" width="100" align="right" editor="{type:'numberbox',options:{min:0,precision:0,groupSeparator:','}}" sortable="true">Harga</th>
                            <th field="quantity" width="100" align="right" editor="{type:'numberbox',options:{min:0,precision:0,groupSeparator:','}}">Jml Retur</th>
         ...
         <div class="box-footer" style="margin-top:-40px !important">
            ...
            <button class="btn btn-warning" name="cancel"><i class="fa fa-save"></i> Batalkan</button>
