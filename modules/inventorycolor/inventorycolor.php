                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Inventory Color</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inventorycolorname" name="inventorycolorname" >
								</div>
							</div>
						</div>
