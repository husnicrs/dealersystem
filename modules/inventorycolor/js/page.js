...
var modulename = "inventorycolor";
var moduledesc = "Inventory Color";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#inventorycolorname").val(data.inventorycolorname);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#inventorycolorname").val(data.inventorycolorname);
			$("#type").val("delete");
			$("#inventorycolorname").val(data.inventorycolorname).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("inventorycolorname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#inventorycolorname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
