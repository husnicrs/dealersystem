      ...
      <div class="box box-solid">
        ...
        <div class="box-body no-padding">
          <ul class="nav nav-pills nav-stacked">
            <li><a href="?mod=ticket"><i class="fa fa-inbox"></i> Pesan Masuk <span class="label label-primary pull-right">				
				<?php
                    $i=1;
                    if($datainboxcount !=0){
            ...
            <li class="active"><a href="?mod=ticket_sent"><i class="fa fa-envelope-o"></i> Pesan Terkirim</a></li>
          </ul>
        </div><!-- /.box-body -->
      </div><!-- /. box -->
      <div class="box box-solid">
