...
$ticket = new Ticket();
$core=new Core();
$data = $ticket->showinboxintermediate($user);
...
<section class="content">
  <div class="row">
    <div class="col-md-3">
      <a href="?mod=ticket_compose" class="btn btn-primary btn-block margin-bottom">Compose</a>
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Pesan Masuk [Sedang]</h3>
