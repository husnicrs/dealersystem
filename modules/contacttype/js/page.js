...
var modulename = "contacttype";
var moduledesc = "Contact Type";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#contacttypename").val(data.contacttypename);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#contacttypename").val(data.contacttypename);
			$("#type").val("delete");
			$("#contacttypename").val(data.contacttypename).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("contacttypename").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#contacttypename").val("").removeAttr( "disabled" );
	$("#type").val("");
}
