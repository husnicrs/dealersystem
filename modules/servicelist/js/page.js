...
var modulename = "servicelist";
var moduledesc = "Service List";
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#cityname").val(data.cityname);
			$("#type").val("delete");
			$("#cityname").val(data.cityname).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("cityname").value; 
...
function clearModals()
{
	...
	$("#cityname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
