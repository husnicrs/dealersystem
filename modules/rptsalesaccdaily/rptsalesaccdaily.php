    ...
    <div class="col-xs-12">
      ...
      <div class="box-header with-border" style="height:50px !important; margin-top:-2px !important">
          ...
          <input type="hidden" class="form-control" id="type" name="type" value="generate">
              ...
              <input type="text" id="rptdatefrom" name="rptdatefrom" onchange="RefreshData()"  value="<?php echo $fbegindate; ?>" style="height:32px !important;"/>
               - <input type="text" id="rptdateto" name="rptdateto" onchange="RefreshData()"   value="<?php echo $fenddate; ?>" style="height:32px !important"/>
