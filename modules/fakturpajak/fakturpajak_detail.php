               ...
               <div class="col-md-4">
            	...
            	<div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="hargajualsw" name="hargajualsw"  value="<?php echo $hargajualsw; ?>" oninput="calculate(); calculatetotalfakturpajak(); calculatetotalppn();">
                     ...
                     <div class="form-group" style="margin-top:-12px !important">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="dppsw" name="dppsw"  value="<?php echo $dppsw; ?>" oninput="calculate(); calculatetotalfakturpajak(); calculatetotalppn();">
                     ...
                     <div class="form-group" style="margin-top:-12px !important">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="ppnsw" name="ppnsw"  value="<?php echo $ppnsw; ?>" oninput="calculate(); calculatetotalfakturpajak(); calculatetotalppn();">
                     ...
                     <div class="form-group" style="margin-top:-12px !important">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="jumlahdppsw" name="jumlahdppsw"  value="<?php echo $jumlahdppsw; ?>" oninput="calculate(); calculatetotalfakturpajak(); calculatetotalppn();">
...
function setUnitData( data )
{
	...
	$("#nota").val(0);
	$("#adm").val(0);
	$("#totalfakturpajak").val(0);
	
	$("#notasw").val(0);
	$("#admsw").val(0);
	$("#totalfakturpajaksw").val(0);
...
function calculate() {
	...
	var result2 = document.getElementById('ppn');
		var rstotalfakturpajak = (ppnsw);
		result2.value = rstotalfakturpajak.replace(/,/g, "");
...
//Calculate Faktur Faktur
function calculatetotalfakturpajak() {
...
function SavePrint1()
{
	...
	$.ajax({
		type: "POST",
		url: "modules/fakturpajak/post/post.php",
		dataType: 'json',
		data: formData,
