  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="box-header with-border">
          <a href="#" data-toggle="modal" data-easein="swoopIn" data-target=".MyModals" type="button" class="btn btn-primary btn-flat"> <i class="fa fa-sticky-note-o"></i> Add New</a>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
                                  <select class="form-control"  style="width: 100%;" name="codetrans" id="codetrans"  placeholder="Transaction Code">
                                      <option value="PR01">Purchase Request</option>
                                  </select>
								</div>
							</div>
						</div>
