...
var modulename = "purchasereq";
var moduledesc = "Purchase Order";
...
function showdetail()
{
	$('#dg').edatagrid({
		...
		onBeforeSave: function(index){
			...
			var color = $(this).edatagrid('getEditor', {
				index: index,
				field: 'colorid'
			});
			var row = $(this).edatagrid('getRows')[index];
			row.inventorycolorname = $(color.target).combobox('getText');
			
			var size = $(this).edatagrid('getEditor', {
				index: index,
				field: 'sizeid'
			});
			var row = $(this).edatagrid('getRows')[index];
			row.inventorysizename = $(size.target).combobox('getText');
