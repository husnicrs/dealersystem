...
">
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=6 class=xl7312617>: <?php echo $notrans ?> [<?php echo $leasing ?>]</td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td colspan=2 class=xl7412617>NAMA</td>
  <td colspan=6 class=xl7412617>: <?php echo strtoupper($cusname) ?></td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl1512617 style='height:15.75pt'></td>
  <td colspan=2 class=xl7312617>ALAMAT</td>
  <td colspan=6 class=xl7312617>: <?php echo strtoupper($address) ?></td>
 </tr>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl1512617 style='height:18.0pt'></td>
  <td colspan=2 class=xl7412617>UANG SEJUMLAH</td>
  <td colspan=6 class=xl7412617>: <b><?php echo ucwords(Terbilang($amount)); ?> RUPIAH</b></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
 ...
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td colspan=2 class=xl7312617>NO RANGKA</td>
  <td colspan=6 height=20 width=943 style='height:15.0pt;width:708pt'
  align=left valign=top><!--[if gte vml 1]><v:shape id="TextBox_x0020_15"
   ...
   margin-left:546.75pt;margin-top:0;width:14.25pt;height:19.5pt;z-index:2;
...

" o:insetmode="auto">
   <v:imagedata src="Kas%20Keluar_files/Book1_12617_image003.png" o:title=""/>
  ...
  position:absolute;z-index:2;margin-left:729px;margin-top:0px;width:19px;
  height:26px'></span><![endif]><span
  style='mso-ignore:vglayout2'>
  <table cellpadding=0 cellspacing=0>
   <tr>
    <td colspan=6 height=20 class=xl7312617 width=943 style='height:15.0pt;
    width:708pt'>:  <?php echo strtoupper($rangkano) ?></td>
   </tr>
  </table>
  </span></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td colspan=2 class=xl7312617>NO MESIN</td>
  <td colspan=6 class=xl7312617>: <?php echo strtoupper($mechineno) ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td colspan=2 class=xl7312617>TAHUN/WARNA</td>
  <td colspan=6 class=xl7312617>: <?php echo strtoupper($year) ?> / <?php echo strtoupper($vehiclecolorname) ?> (<?php echo strtoupper($vehiclecolor) ?>)</td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td class=xl1512617></td>
