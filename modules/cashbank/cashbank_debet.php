<?php
	...
	if (isset($_GET['key'])) {
		$key = $_GET['key'];
		$data = ${"$modulename"}->showslipdebet($key);
		extract($data);
	}
$user=$_SESSION['uname'];
...
<link rel=File-List href="Kas%20Masuk_files/filelist.xml">
<!--[if !mso]>
<style>
...
">
   <v:imagedata src="Kas%20Masuk_files/Book1_12617_image001.png" o:title=""/>
  ...
  src="report/Kas%20Masuk_files/Book1_12617_image002.png" v:shapes="Picture_x0020_1"></span><![endif]><span
  ...
  <td colspan=5 class=xl7412617 width=825 style='width:620pt'><span
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td colspan=6 class=xl7612617 width=926 style='width:696pt'><span
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl6412617 width=20 style='height:15.0pt;width:15pt'></td>
  <td class=xl6412617 width=88 style='width:66pt'></td>
  <td colspan=5 class=xl7512617 width=825 style='width:620pt'><span
  style='mso-spacerun:yes'>               </span>0232-615010</td>
  <td colspan=2 class=xl7812617 width=218 style='width:164pt'></td>
 </tr>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=3 class=xl7712617>SUDAH DITERIMA DARI</td>
  <td class=xl6312617></td>
  <td colspan=2 class=xl7912617></td>
  <td colspan=2 class=xl7212617></td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl1512617 style='height:15.75pt'></td>
  <td colspan=2 class=xl7212617>NO TRANSAKSI</td>
  <td colspan=6 class=xl7212617>: <?php echo $notrans ?> [<?php echo $leasing ?>]</td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td colspan=2 class=xl7112617>NAMA</td>
  <td colspan=6 class=xl7112617>: <?php echo strtoupper($cusname) ?></td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl1512617 style='height:15.75pt'></td>
  <td colspan=2 class=xl7212617>ALAMAT</td>
  <td colspan=6 class=xl7212617>: <?php echo strtoupper($address) ?></td>
 </tr>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl1512617 style='height:18.0pt'></td>
  <td colspan=2 class=xl7112617>UANG SEJUMLAH</td>
  <td colspan=6 class=xl7112617>: <b><?php echo ucwords(Terbilang($amount)); ?>  RUPIAH</b></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td colspan=2 class=xl7312617 width=177 style='width:133pt'>UNTUK PEMBAYARAN</td>
  <td colspan=6 class=xl7312617 width=954 style='width:717pt'>: <?php echo strtoupper($description) ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td colspan=2 class=xl7212617>NO RANGKA</td>
  <td colspan=6 height=20 width=954 style='height:15.0pt;width:717pt'
  align=left valign=top><!--[if gte vml 1]><v:shape id="TextBox_x0020_15"
   o:spid="_x0000_s1028" type="#_x0000_t75" style='position:absolute;
   margin-left:595.5pt;margin-top:0;width:15pt;height:19.5pt;z-index:2;
...

" o:insetmode="auto">
   <v:imagedata src="Kas%20Masuk_files/Book1_12617_image003.png" o:title=""/>
  ...
  position:absolute;z-index:2;margin-left:794px;margin-top:0px;width:20px;
  height:26px'><img width=20 height=26
  src="report/Kas%20Masuk_files/Book1_12617_image004.png" v:shapes="TextBox_x0020_15"></span><![endif]><span
  style='mso-ignore:vglayout2'>
  <table cellpadding=0 cellspacing=0>
   <tr>
    <td colspan=6 height=20 class=xl7212617 width=954 style='height:15.0pt;
    width:717pt'>:  <?php echo strtoupper($rangkano) ?></td>
   </tr>
  </table>
  </span></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td colspan=2 class=xl7212617>NO MESIN</td>
  <td colspan=6 class=xl7212617>: <?php echo strtoupper($mechineno) ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td colspan=2 class=xl7212617>TAHUN/WARNA</td>
  <td colspan=6 class=xl7212617>: <?php echo strtoupper($year) ?> / <?php echo strtoupper($vehiclecolorname) ?> (<?php echo strtoupper($vehiclecolor) ?>)</td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td class=xl1512617></td>
  <td colspan=2 class=xl7012617>RP. <?php echo number_format($amount) ?></td>
  <td class=xl1512617></td>
  <td class=xl6812617></td>
  <td class=xl6812617></td>
  <td colspan=2 class=xl6912617>Kuningan, <?php echo TanggalIndo($dateprint) ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td class=xl1512617></td>
  ...
  <td class=xl1512617></td>
  <td class=xl1512617></td>
  <td colspan=2 class=xl6912617>MITRA UTAMA MOTOR</td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1512617 style='height:15.0pt'></td>
  <td class=xl1512617></td>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl1512617></td>
  <td class=xl1512617></td>
  <td colspan=2 class=xl6912617><?php echo strtoupper($user) ?></td>
 </tr>
