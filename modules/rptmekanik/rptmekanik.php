        ...
        <table id="datagrid"  class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th rowspan="3">Jml Servis</th>
                    <th colspan="5" style="text-align:center">Jenis Pekerjaan</th>
                </tr>
                <tr>
                    <th rowspan="2">KPB</th>
                    <th rowspan="2">Claim (C2)</th>
                    <th colspan="3" style="text-align:center">Quick Service (QS)</th>
                    <th rowspan="2">LR</th>
                    <th rowspan="2">HR</th>
