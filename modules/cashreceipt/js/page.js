...
var modulename = "cashreceipt";
var moduledesc = "Cash Receipt";
...
function setModalData( data )
{
	...
	$('#customerid option[value="' + customerid +'"]').prop("selected", true);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#customerid").val(data.customerid).attr("disabled","false");
...
function clearModals()
{
	...
	$("#customerid").val("").removeAttr( "disabled" );
