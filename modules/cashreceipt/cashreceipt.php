                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">No Trans</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="notrans" name="notrans">
								</div>
							</div>
                            <div class="form-group">
                                <label for="real_name" class="col-sm-3 control-label">Date Trans</label>
                                <div class="col-sm-9">
                                    <div class="input-group">
                                       <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                      <input type="text" class="form-control pull-right" id="datetrans"  placeholder="Date Trans" data-date-format="yyyy-mm-dd" name="datetrans" data-toggle="tooltip" data-placement="top" title="Tanggal Transaksi">
                                    </div><!-- /.input group -->
                                </div>
                            </div>	
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control"  style="width: 100%;" name="customerid" id="customerid"  placeholder="Customer">
                                       <?php
                                            $rl = new Combobox();
                            ...
                            <div class="form-group">
                                <label for="real_name" class="col-sm-3 control-label">Payment Type</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-9">
                                	<input type="text" class="form-control" id="amountsw" name="amountsw" oninput="calculate();">
