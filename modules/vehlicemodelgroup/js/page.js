...
var modulename = "vehlicemodelgroup";
var moduledesc = "Group Model";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#vehlicemodelgroupname").val(data.vehlicemodelgroupname);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#vehlicemodelgroupname").val(data.vehlicemodelgroupname);
			$("#type").val("delete");
			$("#vehlicemodelgroupname").val(data.vehlicemodelgroupname).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("vehlicemodelgroupname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#vehlicemodelgroupname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
        ...
        fields: {
            vehlicemodelgroupname: {
                validators: {
                    ...
                    notEmpty: {
                        message: 'Group Model name is required'
                    }
                }
            }
        }
