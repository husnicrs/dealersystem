...
$slip = new Slip();
	...
	if(isset($_REQUEST['saveclose'])){
        extract($_REQUEST);
		$key = $_GET['key'];
        ${"$modulename"}->saveclose($key, $cusname, $bpkbname, $noktp, $nosim, $address, $villageid, $districtsid, $cityid, 
		$telp, $handphone, $religion, $sex, $datebirth, $job, $maritalstatus, $customerid, $datetrans, $deliverydate, $spkno, $pono, $dono, 
		$vehiclemodel, $vehicletype, $vehiclecolor, $mechineno, $rangkano, $year, $otr, $samsatid, $beanotice, $beaadm, $bbntotal, $policeno, 
		$stnkno, $nostock, $finishdate, $receiver, $bpkbname2, $bpkbno, $bpkbbkservice, $paytypeid, $tunaiscpmd, $tunaiscpdaeler, $tunaidscmarketing, 
		$tunaidsckonsumen, $tunainettbayar, $credittype, $leasing, $subleasing, $creditscmd, $creditscpdealer, $creditsubsidi, $creditgrossdp, 
		$creditdiscmarketing, $creditdisckonsumen, $creditnettdp, $credittenor, $creditcicilan, $creditcostadm, $channelid, $salesmanid, $datebpkb, $datestnk, $username);
	}
                     ...
                     <div class="form-group" style="margin-top:-12px !important">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" id="datebirth"  placeholder="Tanggal Lahir" value="<?php echo $datebirth; ?>"  name="datebirth" data-toggle="tooltip" data-placement="datebirth" title="Tanggal Lahir" data-date-format="dd/mm/yyyy">
                            </div><!-- /.input group -->
                        </div>
                    </div>
                    <div class="form-group" style="margin-top:-12px !important">
                    ...
                    <div class="form-group" style="margin-top:-12px !important">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control"  style="width: 100%;" name="maritalstatus" id="maritalstatus"  placeholder="Status Pernikahan">
                               ...
                               <option value="Lajang">Lajang</option><option value="Duda">Duda</option><option value="Janda">Janda</option>
<option value="Cerai Mati">Cerai Mati</option><option value="Cerai Hidup">Cerai Hidup</option>
                              </select>
                        </div>
                    </div>
                   </fieldset> 
                   ...
                   <fieldset class="scheduler-border">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="customerid1" name="customerid1"  value="<?php echo $customerid; ?>" disabled="disabled">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group" style="margin-top:-12px !important">
                        <label for="real_name" class="col-sm-3 control-label">Subsidi Dealer</label>
                        <div class="col-sm-9">
                 ...
                 <fieldset class="scheduler-border">
                    ...
                    <div class="form-group" style="margin-top:-12px !important">
                     ...
                     <div class="form-group" style="margin-top:-12px !important">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="username1" name="username1"  value="<?php echo $username1; ?>">
                            <input type="hidden" class="form-control" id="username" name="username"  value="<?php echo $username1; ?>">
                        </div>
                    </div>
                    </fieldset> 
                </div>
...
function setUnitData( data )
{
	...
	var channel = data.idchannel;
	$('#channelid option[value="' + channel +'"]').prop("selected", true);
...
//Auto disable enable atribute in form
$(function(){
	var count = <?php echo $statustrans; ?>;
	...
	//For textbox
	 for (var i = 0, len = elements.length; i < len; ++i) {
		elements[i].readOnly = true;
		 ...
		 document.getElementById("paytypeid").disabled = true;
		 document.getElementById("credittype").disabled = true;
		 document.getElementById("leasing").disabled = true;
		 document.getElementById("channelid").disabled = true;
		 document.getElementById("salesmanid").disabled = true;
		 
		 //For button
		 document.getElementById("saveclose").disabled = true;
		...
		$("#creditcostadmsw").attr("disabled", "disabled");
