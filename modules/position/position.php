      ...
      <div class="box-header" style="margin-top:-20px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Jabatan</label>
								<div class="col-sm-9">
		...
		<script>
			function showModals( idkey )
			{
				...
				{
					$("#myModalLabel").html("Tambah <?php echo $subnavmenuname; ?>");
					$("#type").val("new"); 
					waitingDialog.hide();
					$("#myModals").modal("show");
				}
			...
			function deleteData( idkey )
			{
				...
				$.ajax({
					...
					success: function(data) {
						$("#myModalLabel").html("Hapus <?php echo $subnavmenuname; ?>");
						$("#idkey").val(data.idkey);
						$("#positionname").val(data.positionname);
						$("#type").val("delete");
						$("#positionname").val(data.positionname).attr("disabled","false");
			...
			function submitData()
			{
				var counter = document.getElementById("positionname").value; 
				if (counter == '') {
			...
			function clearModals()
			{
				...
				$("#positionname").val("").removeAttr( "disabled" );
				$("#type").val("");
			}
