...
var modulename = "vehicletype";
var moduledesc = "Jenis Kendaraan";
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#vehicletypename").val(data.vehicletypename);
			$("#type").val("delete");
			$("#vehicletypename").val(data.vehicletypename).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("vehicletypename").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#vehicletypename").val("").removeAttr( "disabled" );
	$("#type").val("");
}
