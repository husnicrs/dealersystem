...
switch ($_POST['typefilter']) {
	case "generate":
		...
		creditcostadm='".$_POST['creditcostadm']."', salesmanid='".$_POST['salesmanid']."', sjno='".$_POST['sjno']."', driver='".$_POST['driver']."', status=1, arstatus=2, arbillingdate='1970-01-01' WHERE idtrans='".$_POST['idtrans']."'");
		if($SQL){
			echo json_encode("OK");
		}
