...
var modulename = "customertype";
var moduledesc = "Tipe Pelanggan";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#customertypename").val(data.customertypename);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#customertypename").val(data.customertypename);
			$("#type").val("delete");
			$("#customertypename").val(data.customertypename).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("customertypename").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#customertypename").val("").removeAttr( "disabled" );
	$("#type").val("");
}
