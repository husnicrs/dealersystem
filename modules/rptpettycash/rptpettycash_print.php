<?php
	...
	//error_reporting(0);
	$rptpettycash = new Rptpettycash();
	$core=new Core();
	$data = $rptpettycash->show($rptdatefrom, $rptdateto);
	extract($data);
	
	$datatotal = $rptpettycash->showtotal($rptdatefrom, $rptdateto);
	extract($datatotal);
?>
...
<link rel=File-List href="Kas%20Kecil_files/filelist.xml">
<style id="Kas Besar_16673_Styles">
<!--table
...
<table border=0 cellpadding=0 cellspacing=0 width=1389 style='border-collapse:
 ...
 <tr height=31 style='mso-height-source:userset;height:23.25pt'>
  <td colspan=4 height=31 class=xl6316673 width=1146 style='height:23.25pt;
  width:861pt'>MITRA UTAMA MOTOR</td>
  <td class=xl6316673 width=81 style='width:61pt'></td>
  <td class=xl6316673 width=81 style='width:61pt'></td>
  <td class=xl6316673 width=81 style='width:61pt'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=4 height=20 class=xl6416673 width=1146 style='height:15.0pt;
  width:861pt'>LAPORAN KAS KECIL</td>
  <td class=xl6416673 width=81 style='width:61pt'></td>
  <td class=xl6416673 width=81 style='width:61pt'></td>
  <td class=xl6416673 width=81 style='width:61pt'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=4 height=20 class=xl7316673 width=1146 style='height:15.0pt;
  width:861pt'>PERIODE : <?php echo $rptdatefrom; ?> SAMPAI <?php echo $rptdateto; ?></td>
  <td class=xl6416673 width=81 style='width:61pt'></td>
  <td class=xl6416673 width=81 style='width:61pt'></td>
  <td class=xl6416673 width=81 style='width:61pt'></td>
 </tr>
 ...
 <tr height=22 style='mso-height-source:userset;height:16.5pt'>
  <td colspan=4 height=22 class=xl7016673 width=1146 style='border-right:.5pt solid black;
  height:16.5pt;width:861pt'>TOTAL SALDO</td>
