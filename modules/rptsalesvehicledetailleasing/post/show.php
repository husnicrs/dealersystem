<?php
	...
	$sTable = '(SELECT
				...
				users
				WHERE users.username="'.$user.'" AND CASE WHEN salesvehicle.leasing = "" OR salesvehicle.leasing IS NULL THEN "TUNAI" ELSE salesvehicle.leasing END="'.$key.'" AND salesvehicle.datetrans BETWEEN users.begindate AND users.enddate) DERIVEDTBL'; 
