      ...
      <div class="box-header" style="margin-top:-20px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="accountlvl1name" name="accountlvl1name" >
								</div>
							</div>
						</div>
		...
		<script>
			...
			function setModalData( data )
			{
				...
				$("#type").val("edit");
				$("#accountlvl1name").val(data.accountlvl1name);
			...
			function deleteData( idkey )
			{
				...
				$.ajax({
					...
					success: function(data) {
						...
						$("#accountlvl1name").val(data.accountlvl1name);
						$("#type").val("delete");
						$("#accountlvl1name").val(data.accountlvl1name).attr("disabled","false");
			...
			function submitData()
			{
				var counter = document.getElementById("accountlvl1name").value; 
				if (counter == '') {
			...
			function clearModals()
			{
				...
				$("#accountlvl1name").val("").removeAttr( "disabled" );
				$("#type").val("");
			}
