...
var modulename = "inventorysize";
var moduledesc = "Ukuran Sparepart";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#inventorysizename").val(data.inventorysizename);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#inventorysizename").val(data.inventorysizename);
			$("#type").val("delete");
			$("#inventorysizename").val(data.inventorysizename).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("inventorysizename").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#inventorysizename").val("").removeAttr( "disabled" );
	$("#type").val("");
}
        ...
        fields: {
            inventorysizename: {
                validators: {
                    ...
                    notEmpty: {
                        message: 'Sparepart size is required'
                    }
                }
            }
        }
