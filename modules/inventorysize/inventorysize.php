			...
			<div class="modal-dialog">
                 <form class="form-horizontal" id="formData" action="">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Ukuran Sparepart</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inventorysizename" name="inventorysizename" >
								</div>
							</div>
						</div>
					<div class="modal-footer">
                        ...
                        <button type="submit" id="submitaddnew" onClick="submitDataAdd()" class="btn btn-primary btn-flat pull-right">Sumpan dan Baru </button>
