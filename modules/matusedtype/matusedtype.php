      ...
      <div class="box-header" style="margin-top:-20px">
       ...
       <table id="datagrid"  class="table table-bordered table-hover">
            <thead>
                <tr>
                    <th>Action</th>
                    <th>Jenis Penggunaan Sparepart</th>
                    <th>Status</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Jenis Penggunaan</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="matusedtypename" name="matusedtypename" >
								</div>
							</div>
						</div>
