...
var modulename = "matusedtype";
var moduledesc = "Jenis Penggunaan Material";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#matusedtypename").val(data.matusedtypename);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#matusedtypename").val(data.matusedtypename);
			$("#type").val("delete");
			$("#matusedtypename").val(data.matusedtypename).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("matusedtypename").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#matusedtypename").val("").removeAttr( "disabled" );
	$("#type").val("");
}
        ...
        fields: {
            matusedtypename: {
                validators: {
                    ...
                    notEmpty: {
                        message: 'Material Used Type name is required'
                    }
                }
            }
        }
