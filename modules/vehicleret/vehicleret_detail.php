...
$slip = new Slip();
	...
	if(isset($_REQUEST['retur'])){
        extract($_REQUEST);
		$key = $_GET['key'];
        ${"$modulename"}->retur($key);
    ...
    <div class="col-xs-12">
        ...
        <input type="hidden" class="form-control" id="typefilter" name="typefilter" value="generate">
               ...
               <fieldset class="scheduler-border">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group"  style="margin-bottom:-30px; margin-top:-10px !important">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control"  style="width: 100%;" name="paytypeid" id="paytypeid" placeholder="Jenis Bayar">
         ...
         <div class="pull-right">
            <button class="btn btn-danger" name="retur" id="retur"><i class="fa fa-save"></i> Retur</button>
...
function calculatetotaldp() {
	...
	var result = document.getElementById('creditnettdpsw');
		var gettotal = Number(creditgrossdp) - Number(creditdiscmarketing) - Number(creditdisckonsumen)
