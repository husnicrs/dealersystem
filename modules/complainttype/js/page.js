...
var modulename = "complainttype";
var moduledesc = "Complaint Type";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#complainttypename").val(data.complainttypename);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#complainttypename").val(data.complainttypename);
			$("#type").val("delete");
			$("#complainttypename").val(data.complainttypename).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("complainttypename").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#complainttypename").val("").removeAttr( "disabled" );
	$("#type").val("");
}
