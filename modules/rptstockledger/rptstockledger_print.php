<?php
	$db=new Database();
	//error_reporting(0);
	$rptstockending = new Rptstockending();
	$core=new Core();
...
<table border=0 cellpadding=0 cellspacing=0 width=595 style='border-collapse:
 ...
 <tr class=xl6312617 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl6912617 width=61 style='border-left:none;width:46pt'>Satuan</td>
  <td class=xl6812617 width=87 style='border-left:none;width:65pt'>No Rak</td>
  <td class=xl6812617 width=65 style='border-left:none;width:49pt'>Quantity</td>
 </tr>
 <?php
		$i=1;
		if($data !=0){
