...
var modulename = "inventorygroup";
var moduledesc = "Part Group";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#inventorygroupname").val(data.inventorygroupname);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#inventorygroupname").val(data.inventorygroupname);
			$("#type").val("delete");
			$("#inventorygroupname").val(data.inventorygroupname).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("inventorygroupname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#inventorygroupname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
        ...
        fields: {
            inventorygroupname: {
                validators: {
                    ...
                    notEmpty: {
                        message: 'Part Group name is required'
                    }
                }
            }
        }
