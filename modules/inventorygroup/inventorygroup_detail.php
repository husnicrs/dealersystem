...
$inventorygroup = new Inventorygroup();
	if (isset($_GET['key'])) {
	    $key = $_GET['key'];
	    $data = $inventorygroup->showDetail($key);
	    extract($data);
	}
?>
           ...
           <div class="box-body">
               ...
               <div class="col-md-10">
                <div class="form-group">
                    <label for="real_name" class="col-sm-1 control-label">Part Group</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="inventorygroupname" name="inventorygroupname"  value="<?php echo $inventorygroupname; ?>">
                    </div>
                </div>
             </div>
            </div>
...
$(function(){
	$('#dg11').edatagrid({
		url: 'modules/inventorygroup/post/detail/get.php?key=<?php echo $key ?>',
		saveUrl: 'modules/inventorygroup/post/detail/save.php?key=<?php echo $key ?>',
		updateUrl: 'modules/inventorygroup/post/detail/update.php',
		destroyUrl: 'modules/inventorygroup/post/detail/destroy.php',
...
<div class="box" style="margin-bottom:-10px !important">
 <div class="nav-tabs-custom"></div>
	...
	<table id="dg11" style="height:300px"
        toolbar="#toolbar" pagination="true" idField="idinventorygroupdet"
                                        ...
                                        options:{
                                            ...
                                            columns:[[
                                             ...
                                             onSelect: function(index,row){
                                                 setTimeout(function(){
                                                     var opts = $('#dg11').edatagrid('options');
                                                     var ed = $('#dg11').edatagrid('getEditor',{
                                                         index:opts.editIndex,
                                                         field:'unitprice'
                                                     });
                                                     var edinvname = $('#dg11').edatagrid('getEditor',{
                                                         index:opts.editIndex,
                                                         field:'inventoryname'
                                                     });
