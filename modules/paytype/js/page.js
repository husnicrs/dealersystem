...
var moduledesc = "Jenis Pembayaran";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#paytypename").val(data.paytypename);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#paytypename").val(data.paytypename);
			$("#type").val("delete");
			$("#paytypename").val(data.paytypename).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("paytypename").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#paytypename").val("").removeAttr( "disabled" );
	$("#type").val("");
}
