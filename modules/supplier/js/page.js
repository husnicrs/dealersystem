...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#suppliername").val(data.suppliername).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("suppliername").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#suppliername").val("").removeAttr( "disabled" );
