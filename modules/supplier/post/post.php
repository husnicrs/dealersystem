...
switch ($_POST['type']) {
	...
	case "new":
		...
		"INSERT INTO supplier SET registrationno='".$_POST['registrationno']."', 
		suppliername='".$_POST['suppliername']."', address1='".$_POST['address1']."',  
	...
	case "edit":
		$SQL = mysqli_query($con, 
		"UPDATE supplier SET registrationno='".$_POST['registrationno']."', 
		suppliername='".$_POST['suppliername']."', address1='".$_POST['address1']."',  
		phone1='".$_POST['phone1']."', phone2='".$_POST['phone2']."',
		status='".$_POST['status']."' WHERE idsupplier='".$_POST['idkey']."'");
		if($SQL){
			echo json_encode("OK");
		}			
		break;
