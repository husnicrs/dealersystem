...
<section class="content-header" style="margin-top:-15px !important; margin-bottom:-20px !important">
  <h4>
    Supplier: <?php echo $customername; ?>
  </h4>
</section>
<!-- Main content -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td class="left"><?php echo $inventorycolorname; ?></td>
                    <td class="left"><?php echo $unit; ?></td>
                    <td class="left"><?php echo number_format($quantity); ?></td>
                    <td class="left"><?php echo number_format($poremain); ?></td>
                    <td class="centeralign">
                        <input type="checkbox" name="checkedid[]" class="checkbox" id="check" value="<?PHP echo $idtransdet;?>" onchange="myFunction(this)">
                    </td>
                    <td>
                        <input type="text" class="form-control input-sm" style="height:22px; margin-bottom:-3px; margin-top:-4px !important" name="totalpick[]" id="totalpick<?PHP echo $idtransdet;?>" value="<?PHP echo $poremain;?>" disabled="disabled"  onkeyup="numericFilter(this); updateSum();" >
                    </td>
                </tr>
                <?php
                    $i++;
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <select class="form-control"  style="width: 100%;" name="codetrans" id="codetrans"  placeholder="Transaction Code">
                              <option value="POLC">Purchase Order Local</option>
                              <option value="POIM">Purchase Order Import</option>
                          </select>
                        </div>
                    </div>
                </div>
