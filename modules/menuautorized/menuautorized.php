<?php
include_once 'modules/menuautorized_showmenu.php';
?>
		...
		<script type="text/javascript" language="javascript" >
			...
			$(document).ready(function() {
				dTable = $('#datagrid').DataTable( {
					...
					"bJQueryUI": false,
					"responsive": true,
					"sAjaxSource": "modules/menuautorized/post/menuautorized_show.php",
					"sServerMethod": "POST",
					"columnDefs": [
		...
		<script>
			function showModals( iduser )
			{
				...
				if( iduser )
				{
					...
					$.ajax({
						type: "POST",
						url: "modules/menuautorized/post/menuautorized_post.php",
						dataType: 'json',
