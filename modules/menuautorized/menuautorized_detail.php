        ...
        <div class="box-body">
           <div class="nav-tabs-custom" style="margin-top:-20px !important;">
                 <ul class="nav nav-tabs">
                  <li class="active" data-toggle="tooltip" data-placement="top" title="Tambah data otorisasi menu baru"><a href="index.php?mod=menuautorized_detail&key=<?php echo $key ?>" >Otorisasi Menu </a></li>
                  <li data-toggle="tooltip" data-placement="top" title="Tambah data otorisasi bidang"><a href="index.php?mod=menuautorized_detailloc&key=<?php echo $key ?>">Otorisasi Lokasi </a></li>
                </ul>
            </div>
		...
		<script type="text/javascript" language="javascript" >
			...
			$(document).ready(function() {
				dTable = $('#datagrid').DataTable( {
					...
					"bJQueryUI": false,
					"responsive": true,
					"sAjaxSource": "<?php echo $pagepost; ?>menuautorized_showdetail.php?key=<?php echo $key ?>",
					"sServerMethod": "POST",
					"columnDefs": [
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">User Autorized</h4>
					</div>
                    ...
                    <div class="row">
						<form class="form-horizontal" id="formData" action="">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Nama Menu</label>
								<div class="col-sm-8">
                                  <select class="col-sm-2 control-label"  style="width: 100%;" name="menuid" id="menuid">
        ...
        <div class="modal fade" id="myModalsDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="myModalLabel">Delete User Autorized</h4>
					</div>
		...
		<script>
			function showModals( iduserautorized )
			{
				...
				if( iduserautorized )
				{
					...
					$.ajax({
						type: "POST",
						url: "<?php echo $pagepost; ?>menuautorized_post.php",
						dataType: 'json',
				...
				{
					$("#myModals").modal("show");
					$("#myModalLabel").html("New User Autorized");
					$("#type").val("new"); 
					waitingDialog.hide();
				}
			}
			...
			function setModalData( data )
			{
				...
				var i = data.menuid;
				$('#menuid option[value="' + i +'"]').prop("selected", true);
				$("#myModals").modal("show");
				waitingDialog.hide();	
			}
			function deleteUser( iduserautorized )
			{
				...
				$.ajax({
					type: "POST",
					url: "<?php echo $pagepost; ?>menuautorized_postdelete.php",
					dataType: 'json',
