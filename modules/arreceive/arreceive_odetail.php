...
if(isset($_REQUEST['submit'])){
	extract($_REQUEST);
	${"$modulename"}->pickheader($codetrans, $notrans, $datetrans, $customerid);
...
<section class="content-header" style="margin-top:-15px !important; margin-bottom:-20px !important">
  <h4>
    Pelanggan: <?php echo $customername; ?>
  </h4>
</section>
<!-- Main content -->
<section class="content">
 ...
 <input type="hidden" class="form-control" id="customerid" name="customerid" value="<?php echo $idcustomer; ?>">
  <div class="row">
    <div class="col-xs-12">
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <select class="form-control"  style="width: 100%;" name="codetrans" id="codetrans"  placeholder="Kode Transaksi">
                              <option value="ARRC">Penerimaan Piutang</option>
                          </select>
                        </div>
                    </div>
                </div>
