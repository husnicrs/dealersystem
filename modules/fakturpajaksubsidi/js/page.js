...
var modulename = "fakturpajaksubsidi";
var moduledesc = "Faktur Pajak Subsidi";
...
window.onload= function(){
	//Calculate quantity
    n2= document.getElementById('hargajualsw');

    n2.onkeyup=n2.onchange= function(e){
        e=e|| window.event; 
        var who=e.target || e.srcElement,temp;
        if(who.id==='hargajual')  temp= validDigits(who.value,0); 
   ...
   n2.onblur= function(){
	...
	//Calculate 
    n3= document.getElementById('dppsw');

    n3.onkeyup=n3.onchange= function(e){
        e=e|| window.event; 
        var who=e.target || e.srcElement,temp;
        if(who.id==='dpp')  temp= validDigits(who.value,0); 
        else temp= validDigits(who.value);
        who.value= addCommas(temp);
    }   
   n3.onblur= function(){
	...
	//Calculate 
    n4= document.getElementById('ppnsw');
   ...
   n4.onblur= function(){
		...
		//Calculate 
    n5= document.getElementById('jumlahdppsw');

    n5.onkeyup=n5.onchange= function(e){
        e=e|| window.event; 
        var who=e.target || e.srcElement,temp;
        if(who.id==='jumlahdpp')  temp= validDigits(who.value,0); 
        else temp= validDigits(who.value);
        who.value= addCommas(temp);
    }   
   n5.onblur= function(){
