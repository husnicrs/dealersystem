...
${"$modulename"} = new Salesvehicleunit();
$slip = new Slip();
	if (isset($_GET['key'])) {
	    $key = $_GET['key'];
	...
	if(isset($_REQUEST['saveclose'])){
        extract($_REQUEST);
		$key = $_GET['key'];
        ${"$modulename"}->saveclose($key,  $policeno, $stnkno, $nostock, $finishdate, $receiver, $bpkbname2, $bpkbno, $bpkbbkservice, $tglambil, $datestnk, $datebpkb);
	}
            ...
            <div class="box-header with-border">
               ...
               <fieldset class="scheduler-border">
                ...
                <div class="col-md-4" style="margin-bottom:-20px !important">
                    ...
                    <div class="form-group" style="margin-top:-12px !important">
                        <label for="real_name" class="col-sm-3 control-label">Tgl Ambil</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                               <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                              <input type="text" class="form-control pull-right" id="tglambil"  placeholder="Tgl Ambil" value="<?php echo $tglambil; ?>"  name="tglambil" data-toggle="tooltip" data-placement="Tgl Ambil" title="Tgl Ambil" data-date-format="dd/mm/yyyy">
                            </div><!-- /.input group -->
                        </div>
                    </div>
                     <div class="form-group" style="margin-top:-12px !important">
