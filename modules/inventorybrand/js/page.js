...
var modulename = "inventorybrand";
var moduledesc = "Merek Sparepart";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#inventorybrandname").val(data.inventorybrandname);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#inventorybrandname").val(data.inventorybrandname);
			$("#type").val("delete");
			$("#inventorybrandname").val(data.inventorybrandname).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("inventorybrandname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#inventorybrandname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
