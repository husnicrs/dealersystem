                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Kode Akun</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="accountcode" name="accountcode" >
								</div>
							</div>
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Nama Akun</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="accountname" name="accountname" >
								</div>
							</div>
                            <div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Akun Level 1</label>
								<div class="col-sm-9">
								  <select class="form-control"  style="width: 100%;" name="accountlvl1id" id="accountlvl1id"  placeholder="Akun Level 1">
                                  <option value="<?php echo $idcity; ?>"><?php echo $cityname; ?></option>
                                   <?php
                                        $rl = new Combobox();
                                        $datarl = $rl->showAccountLvl1();
                                        foreach ($datarl as $value) {
                                            extract($value);
                                            echo "<option value='".$idaccountlvl1."'>".$accountlvl1name."</option>";
                                        }
                                    ?>
                                  </select>
								</div>
