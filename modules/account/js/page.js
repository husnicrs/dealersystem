...
function setModalData( data )
{
	...
	var accountlvl1id = data.accountlvl1id;
	$('#accountlvl1id option[value="' + accountlvl1id +'"]').prop("selected", true);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#accountname").val(data.accountname);
			$("#type").val("delete");
			$("#accountname").val(data.accountname).attr("disabled","false");
			$("#accountlvl1id").val(data.accountlvl1id).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("accountname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#accountcode").val("").removeAttr( "disabled" );
	$("#accountname").val("").removeAttr( "disabled" );
	$("#accountlvl1id").val("").removeAttr( "disabled" );
	$("#type").val("");
}
