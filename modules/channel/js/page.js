...
var modulename = "channel";
var moduledesc = "Channel";
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#channelname").val(data.channelname);
			$("#type").val("delete");
			$("#channelname").val(data.channelname).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("channelname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#channelname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
