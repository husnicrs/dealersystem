...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#vehlicetype").val(data.vehlicetype);
	$("#vehlicemodel").val(data.vehlicemodel);
	$("#vehlicejenis").val(data.vehlicejenis);
	$("#cc").val(data.cc);
	$("#otr").val(data.otr);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#idkey").val(data.idkey);
			$("#type").val("delete");
			$("#vehlicetype").val(data.vehlicetype).attr("disabled","false");
			$("#vehlicemodel").val(data.vehlicemodel).attr("disabled","false");
			$("#vehlicejenis").val(data.vehlicejenis).attr("disabled","false");
			$("#cc").val(data.cc).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("vehlicetype").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#vehlicetype").val("").removeAttr( "disabled" );
	$("#vehlicemodel").val("").removeAttr( "disabled" );
	$("#vehlicejenis").val("").removeAttr( "disabled" );
	$("#cc").val("").removeAttr( "disabled" );
        ...
        fields: {
            vehlicetype: {
                validators: {
                    ...
                    notEmpty: {
                        message: 'Kendaraan name is required'
                    }
                }
            }
        }
