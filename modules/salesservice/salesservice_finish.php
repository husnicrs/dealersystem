...
$slip = new Slip();
	if (isset($_GET['key'])) {
	    ...
	    extract($data);
		$datadetail = $salesservice->showpartslipdetail($key);
		$datatotal = $salesservice->showsliptotal($key);
...
<script type="text/javascript">
	...
	window.onload = function() {
		var w = PopupCenter('report.php?mod=salesservice_slip&key=<?php echo $key; ?>','Popup_Window','900','670');
