...
var modulename = "businesstype";
var moduledesc = "Business Type";
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#businesstypename").val(data.businesstypename);
			$("#type").val("delete");
			$("#businesstypename").val(data.businesstypename).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("businesstypename").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#businesstypename").val("").removeAttr( "disabled" );
	$("#type").val("");
}
