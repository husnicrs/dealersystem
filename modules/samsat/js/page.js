...
var modulename = "samsat";
var moduledesc = "Samsat";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#samsatname").val(data.samsatname);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#samsatname").val(data.samsatname);
			$("#type").val("delete");
			$("#samsatname").val(data.samsatname).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("samsatname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#samsatname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
