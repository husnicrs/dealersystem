    ...
    <div class="col-xs-12">
        ...
        <input type="hidden" class="form-control" id="transid" name="transid" value="<?php echo $key; ?>">
     	<input type="hidden" class="form-control" id="type" name="type" value="generate">
            <div class="box-header with-border">
               ...
               <div class="col-md-4">
                    <div class="form-group">
                        <label for="real_name" class="col-sm-3 control-label">No Opnam</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="transno" name="transno"  disabled="disabled" value="<?php echo $notrans; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="real_name" class="col-sm-3 control-label">Tgl Opnam</label>
                        <div class="col-sm-9">
          ...
          <div class="box-body">
                <table id="dg" style="height:350px"
                    ...
                    <thead>
                        <tr>
                            <th data-options="field:'inventoryid', width:400, sortable:true, nowrap:true,
                            ...
                            <th field="stockqty" width="100" align="right" editor="{type:'numberbox',options:{precision:0,groupSeparator:','}}">Jml Sistem</th>
                            <th field="quantity" width="100" align="right" editor="{type:'numberbox',options:{precision:0,groupSeparator:','}}">Jml Fisik</th>
                            <th field="adjqty" width="100" align="right" editor="{type:'numberbox',options:{precision:0,groupSeparator:','}}">Jml Koreksi</th>
         ...
         <div class="box-footer" style="margin-top:-40px !important">
             <a href="#" onclick="generateData()" type="button" class="btn btn-primary"> <i class="fa fa-magic"></i> Ambil Stok</a>
            ...
            <button class="btn btn-warning" name="cancel"><i class="fa fa-eraser"></i> Batal</button>
            <button class="btn btn-danger" name="delete"><i class="fa fa-trash"></i> Hapus</button>
