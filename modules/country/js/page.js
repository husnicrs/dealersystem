...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#countrycode").val(data.countrycode);
			$("#type").val("delete");
			$("#countryname").val(data.countryname).attr("disabled","false");
			$("#countrycode").val(data.countrycode).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("countryname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#countryname").val("").removeAttr( "disabled" );
