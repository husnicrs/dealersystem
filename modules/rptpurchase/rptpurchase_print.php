<?php
	...
	//error_reporting(0);
	$rptpurchase = new Rptpurchase();
	$core=new Core();
	$data = $rptpurchase->show($datefrom, $dateto);
	extract($data);
	$datatotal = $rptpurchase->showtotal($datefrom, $dateto);
	extract($datatotal);
?>
...
<table border=0 cellpadding=0 cellspacing=0 width=983 style='border-collapse:
 ...
 <tr height=27 style='mso-height-source:userset;height:20.25pt'>
  ...
  <td class=xl6612617 colspan=2>PURCHASE REPORT</td>
  <td class=xl1512617></td>
  <td class=xl1512617></td>
 ...
 <tr class=xl6312617 height=28 style='mso-height-source:userset;height:21.0pt'>
  ...
  <td class=xl6912617 width=123 style='border-left:none;width:92pt'>Pay Type</td>
  <td class=xl6912617 width=178 style='border-top:none;border-left:none;
  width:134pt'>Inventory</td>
  ...
  width:48pt'>Qty</td>
  <td class=xl6912617 width=41 style='border-top:none;border-left:none;
  width:31pt'>Disc %</td>
  <td class=xl6912617 width=76 style='border-top:none;border-left:none;
  width:57pt'>Amount</td>
 </tr>
 <?php
		$i=1;
		if($data !=0){
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  width:141pt'><?php echo $suppliername; ?></td>
  ...
  <td class=xl6812617 width=41 style='border-top:none;border-left:none;
  width:31pt'><?php echo $discount; ?></td>
  <td class=xl6812617 width=76 style='border-top:none;border-left:none;
  width:57pt'><?php echo $amount; ?></td>
 </tr>
	<?php
	$i++;
		}
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl6312617><?php echo $tquantity; ?></td>
