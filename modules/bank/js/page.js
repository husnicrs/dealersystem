...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#branch").val(data.branch);
			$("#type").val("delete");
			$("#bankname").val(data.bankname).attr("disabled","false");
			$("#bankaccount").val(data.bankaccount).attr("disabled","false");
			$("#banknumber").val(data.banknumber).attr("disabled","false");
			$("#branch").val(data.branch).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("bankname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#bankname").val("").removeAttr( "disabled" );
	$("#bankaccount").val("").removeAttr( "disabled" );
	$("#banknumber").val("").removeAttr( "disabled" );
	$("#branch").val("").removeAttr( "disabled" );
	$("#type").val("");
}
