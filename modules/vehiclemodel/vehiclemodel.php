                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Model Kendaraan</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="vehiclemodelname" name="vehiclemodelname" >
								</div>
							</div>
                            <div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Jenis Kendaraan</label>
								<div class="col-sm-9">
								  <select class="form-control"  style="width: 100%;" name="vehicletypeid" id="vehicletypeid">
                                    <option value=<?php echo $vahicletypeid; ?>><?php echo $vehicletypename; ?></option>
                                   <?php
                                        $rl = new Combobox();
                                        $datarl = $rl->showVahicletype();
                                        foreach ($datarl as $value) {
                                            extract($value);
                                            echo "<option value='".$idvehicletype."'>".$vehicletypename."</option>";
                                        }
                                    ?>
                                  </select>
								</div>
                            ...
                            <div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Type Kendaraan</label>
								<div class="col-sm-9">
									<select class="form-control"  style="width: 100%;" name="vehiclegroupid" id="vehiclegroupid">
                                    <option value=<?php echo $vahiclegroupid; ?>><?php echo $vehiclegroupname; ?></option>
                                   <?php
                                        $rl = new Combobox();
                                        $datarl = $rl->showVahiclegroup();
                                        foreach ($datarl as $value) {
                                            extract($value);
                                            echo "<option value='".$idvehiclegroup."'>".$vehiclegroupname."</option>";
                                        }
                                    ?>
                                  </select>
								</div>
