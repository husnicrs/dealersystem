...
var modulename = "vehiclemodel";
var moduledesc = "Model Kendaraan";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#vehiclemodelname").val(data.vehiclemodelname);
	
	var vehicletypeid = data.vehicletypeid;
		$('#vehicletypeid option[value="' + vehicletypeid +'"]').prop("selected", true);
		
	var vehiclegroupid = data.vehiclegroupid;
		$('#vehiclegroupid option[value="' + vehiclegroupid +'"]').prop("selected", true);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#vehiclemodelname").val(data.vehiclemodelname);
			$("#type").val("delete");
			$("#vehiclemodelname").val(data.vehiclemodelname).attr("disabled","false");
			$("#vehicletypeid").val(data.vehicletypeid).attr("disabled","false");
			$("#vehiclegroupid").val(data.vehiclegroupid).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("vehiclemodelname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#vehiclemodelname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
