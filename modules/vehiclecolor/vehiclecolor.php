                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Kode Warna</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="vehiclecolorcode" name="vehiclecolorcode" >
								</div>
							</div>
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Warna Kendaraan</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="vehiclecolorname" name="vehiclecolorname" >
								</div>
							</div>
						</div>
