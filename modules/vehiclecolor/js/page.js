...
var modulename = "vehiclecolor";
var moduledesc = "Warna Kendaraan";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#vehiclecolorcode").val(data.vehiclecolorcode);
	$("#vehiclecolorname").val(data.vehiclecolorname);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#vehiclecolorname").val(data.vehiclecolorname);
			$("#type").val("delete");
			$("#vehiclecolorcode").val(data.vehiclecolorcode).attr("disabled","false");
			$("#vehiclecolorname").val(data.vehiclecolorname).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("vehiclecolorname").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#vehiclecolorname").val("").removeAttr( "disabled" );
	$("#type").val("");
}
