                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Nama Servis</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="vehicleservicename" name="vehicleservicename">
								</div>
							</div>
                            <div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Jenis Servis</label>
								<div class="col-sm-9">
                                     <select class="form-control"  style="width: 100%;" name="vehliceservicetype" id="vehliceservicetype">
                                        <option value=<?php echo $vehliceservicetype; ?>><?php echo $vehliceservicetype; ?></option>
                            ...
                            <div class="form-group" style="margin-top:-12px !important">
                                <label for="real_name" class="col-sm-3 control-label">Grup Model</label>
                                <div class="col-sm-9">
                                     <select class="form-control"  style="width: 100%;" name="vehiclegroupmodel" id="vehiclegroupmodel">
                                        <option value=<?php echo $vehiclegroupmodel; ?>><?php echo $vehiclegroupmodel; ?></option>
									   <?php
                                            $rl = new Combobox();
                                            $datarl = $rl->showVehiclegroupmodel();
                                            foreach ($datarl as $value) {
                                                extract($value);
                                                echo "<option value='".$vehlicemodelgroupname."'>".$vehlicemodelgroupname."</option>";
                                            }
                                        ?>
                                      </select>
                                </div>
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-3 control-label">Harga</label>
								<div class="col-sm-9">
