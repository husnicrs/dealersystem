...
var modulename = "vehicleservice";
var moduledesc = "Jenis Servis";
...
function setModalData( data )
{
	...
	$("#type").val("edit");
	$("#vehicleservicename").val(data.vehicleservicename);
	$("#vehicleservicetype").val(data.vehicleservicetype);
	$("#unitprice").val(data.unitprice);
	
	var vehiclegroupmodel = data.vehiclegroupmodel;
	$('#vehiclegroupmodel option[value="' + vehiclegroupmodel +'"]').prop("selected", true);
	
	var vehliceservicetype = data.vehliceservicetype;
	$('#vehliceservicetype option[value="' + vehliceservicetype +'"]').prop("selected", true);
...
function deleteData( idkey )
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#unitprice").val(data.unitprice);
			$("#type").val("delete");
			$("#vehicleservicename").val(data.vehicleservicename).attr("disabled","false");
...
function submitData()
{
	var counter = document.getElementById("vehicleservicename").value; 
	if (counter == '') {
...
function clearModals()
{
	...
	$("#vehicleservicename").val("").removeAttr( "disabled" );
	$("#vehicleservicetype").val("").removeAttr( "disabled" );
	$("#vehiclegroupmodel").val("").removeAttr( "disabled" );
